...
[OpenOCD](../../../sw/doc/OPENOCD_INSTALLATION.md) and XSDB (coming with Vivado). Both connect to port 3004 for all cores, except for `CORE_MICROBLAZEV_RV64`, which requires port 3005.
